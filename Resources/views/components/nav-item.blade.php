...
<div x-data="{ open: false }" wire:key="{{ $statePath }}" data-id="{{ $statePath }}"
    data-sortable-item>
    <div class="relative group">
        <div @class([
            ...
            <button type="button"
                {{-- @if (!$disableRecordEdit)  --}}
                    wire:click="editItem('{{ $statePath }}')" wire:loading.attr="disabled" 
                {{-- @endif --}}
        ...
        @if (!$disableNewChildRecordCreation || !$disableRecordDeletion)
            <div @class([
